...
function Footer() {
  ...
  // return <footer className="footer">{isOpen && (<p>We're currently open</p>)}</footer>; // short circuiting
  return (
    <footer className="footer">
      {isOpen ? (
        ...
        <p>
          We're happy to welcome you again between {openHour}:00 and {closeHour}:00
        </p>
      )}
    </footer>
  );
